class Signup
  ...
  def save
    run_callbacks :save do
      ...
      user = User.new(name: name, email: email, password: password, password_confirmation: password_confirmation,activation_digest: activation_digest,activation_token: activation_token)
      user.save!
